...
const Stats = () => {
    ...
    return (
        ...
        <div className=' container mx-auto'>
            ...
            <div className='bg-white shadow-sm rounded-2xl w-10/10 h-[600] ml-4 mr-4 my-4 mx-auto'>
...

                {
                    timeline.length === 0 ? (
                        <div className="flex justify-center items-center h-[300px]">
                            <p className="text-gray-500 text-center text-lg">No Data</p>
                        </div>
                    ) : (
                        <div className='flex justify-center my-15' >
                            <PieChart style={{ width: '100%', maxWidth: '390px', maxHeight: '80vh', aspectRatio: 1 }} responsive>
                                <Pie
                                    data={data}
                                    innerRadius="80%"
                                    outerRadius="100%"
